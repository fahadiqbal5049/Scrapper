...
const SignUpModal: React.FC<Props> = ({ isOpen, closeEvent }: Props) => {
  return (
      ...
      >
        ...
        <div className="size-full max-w-full flex flex-col items-center justify-between gap-5">
          <Typography color="primary" className="text-center">
            We use Canny to collect feedback from users like you. Sign up to
            post and vote.
          </Typography>
          <Typography
            variant="h3"
          ...
          <Typography color="primary">Need an account? Log in</Typography>
        </div>
