...
interface WeeklyRangeCalenderProps {
  isOpen: boolean;
  value: DateObject[];
...
const WeeklyRangeCalender: React.FC<WeeklyRangeCalenderProps> = ({
  isOpen,
  value,
  onChange,
}) => {
  ...
  return (
    <div
      className="flex weekly-range select-none py-3 relative flex-col"
      ref={containerRef}
    >
...
export default WeeklyRangeCalender;
