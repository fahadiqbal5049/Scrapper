    ...
    <div className="size-full flex flex-col items-start justify-start gap-5 lg:gap-8">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbPage>Est Monthly Google Ads Budget</BreadcrumbPage>
        </BreadcrumbList>
      </Breadcrumb>
            ...
            <LineChart accessibilityLayer data={chartData}>
              ...
              <ChartTooltip
                ...
                content={
                  <ChartTooltipContent
                    hideLabel
                    formatter={(value) => `Google Ads Budget : ${value}K`}
                  />
                }
              />
              <Line
...
export default MonthlyGoogleAdsBudget;
