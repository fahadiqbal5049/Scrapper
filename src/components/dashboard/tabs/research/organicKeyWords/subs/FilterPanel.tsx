          ...
          <div className="w-full gap-5 p-3 flex flex-col">
            ...
            <div className="flex w-full flex-col gap-2">
              ...
              <div className="w-full border-[1px] rounded-[2px]  border-[#4E4E4E] grid grid-cols-[90px,1fr]">
                ...
                <Input className="border-none" placeholder="example.com/blog" />
              </div>
            </div>
            {/*  */}
            <div className="w-full flex justify-between items-center">
              <div className="flex justify-start items-center gap-2">
                <Checkbox id="exclude-homepage-keywords" />
                <label htmlFor="exclude-homepage-keywords">
                  <Typography
                    variant="p"
                    color="primary"
                    className="font-semibold"
                  >
                    Exclude Homepage Keywords
                  </Typography>
                </label>
              </div>
              <InputHelpTooltip />
