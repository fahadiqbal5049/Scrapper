...
const RemoveUserDialog: React.FC = () => {
  ...
  return (
    <Dialog>
      <DialogTrigger>
        <div className="bg-pink-1/10 hover:opacity-70 p-1 rounded-sm">
          <X size={22} className="text-pink-1" />
        </div>
      </DialogTrigger>
      <DialogContent className="md:min-w-[560px] py-8 flex flex-col gap-6 max-h-[95dvh] !overflow-y-auto max-w-[90%] md:max-w-[560px] w-[90%] bg-primary border-none rounded-3xl">
        ...
        {/* full name */}
        <div className="w-full grid grid-cols-[100px,1fr] md:grid-cols-[130px,1fr]">
        ...
        <div className="w-full grid grid-cols-[100px,1fr] md:grid-cols-[130px,1fr]">
          ...
          <textarea className="w-full resize-none focus:outline-none rounded-[2px] text-white-1/80 focus:text-white-1/80 text-sm h-[100px] bg-[#3A4249] py-1 px-3 border-none" />
        </div>
        <div className="w-full flex justify-end items-center gap-5">
          <DialogClose>
            <div className="rounded-sm border hover:text-neutral-900 px-3 text-xs flex justify-center items-center border-white-2 bg-transparent text-white-2 hover:border-transparent shadow-sm hover:bg-neutral-100 min-w-[120px] sm:min-w-[170px] h-[28px]">
              Cancel
            </div>
          </DialogClose>
          <Button
            ...
            size="sm"
            className="rounded-sm min-w-[120px] sm:min-w-[170px] h-[28px]"
          >
            Accept
          </Button>
        </div>
