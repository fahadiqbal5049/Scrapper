...
import { RepricingHistoyProducts } from "@/data/repricingData";
    ...
    <div className="w-full bg-primary rounded-lg pt-4 pb-5 sm:pt-5 sm:pb-6 sm:px-4 px-3 ">
      <div className="size-full flex flex-col items-start justify-start gap-5">
        <div className="w-full flex items-center  gap-4  justify-between">
          <span className="h-[22px] px-3 bg-success-2/10 rounded-full">
            {" "}
            <Typography color="primary" className="text-success-2">
              0 Runs
            </Typography>
          </span>
        ...
        <ScrollArea>
          <Table className="min-w-[1000px]">
            ...
            <TableBody>
              {RepricingHistoyProducts.map((order, index) => (
                <TableRow
                  key={index}
                  className={clsx(
                    "h-[35px]",
                ...
                >
                  ...
                  <TableCell as="td" className="">
                    <Typography color="secondary">10/11/23 at 10 AM</Typography>
                  </TableCell>
                  <TableCell as="td" className="">
